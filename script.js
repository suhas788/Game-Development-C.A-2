    ...
    function startTimer() {
        ...
        var timerInterval = setInterval(function () {
            if (seconds > 0) {
                ...
                alert('Timer expired!'); // You can replace this with your desired action when the timer expires
            }
...
// Example of updating the score (you can call this function in response to game events)
updateScore(10); // Increase the score by 10
